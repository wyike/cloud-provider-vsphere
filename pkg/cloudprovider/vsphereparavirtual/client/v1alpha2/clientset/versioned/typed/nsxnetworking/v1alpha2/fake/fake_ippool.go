...
type FakeIPPools struct {
	Fake *FakeNsxV1alpha2
	ns   string
}

var ippoolsResource = schema.GroupVersionResource{Group: "nsx.vmware.com", Version: "v1alpha2", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "nsx.vmware.com", Version: "v1alpha2", Kind: "IPPool"}
...
func (c *FakeIPPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.IPPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ippoolsResource, c.ns, name), &v1alpha2.IPPool{})
...
func (c *FakeIPPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.IPPoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ippoolsResource, ippoolsKind, c.ns, opts), &v1alpha2.IPPoolList{})
...
func (c *FakeIPPools) Create(ctx context.Context, iPPool *v1alpha2.IPPool, opts v1.CreateOptions) (result *v1alpha2.IPPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ippoolsResource, c.ns, iPPool), &v1alpha2.IPPool{})
...
func (c *FakeIPPools) Update(ctx context.Context, iPPool *v1alpha2.IPPool, opts v1.UpdateOptions) (result *v1alpha2.IPPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ippoolsResource, c.ns, iPPool), &v1alpha2.IPPool{})
...
func (c *FakeIPPools) UpdateStatus(ctx context.Context, iPPool *v1alpha2.IPPool, opts v1.UpdateOptions) (*v1alpha2.IPPool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ippoolsResource, "status", c.ns, iPPool), &v1alpha2.IPPool{})
...
func (c *FakeIPPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(ippoolsResource, c.ns, name, opts), &v1alpha2.IPPool{})
...
func (c *FakeIPPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.IPPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ippoolsResource, c.ns, name, pt, data, subresources...), &v1alpha2.IPPool{})
