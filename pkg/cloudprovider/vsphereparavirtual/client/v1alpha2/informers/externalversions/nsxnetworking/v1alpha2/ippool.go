...
import (
	...
	nsxnetworkingv1alpha2 "k8s.io/cloud-provider-vsphere/pkg/cloudprovider/vsphereparavirtual/apis/nsxnetworking/v1alpha2"
	versioned "k8s.io/cloud-provider-vsphere/pkg/cloudprovider/vsphereparavirtual/client/v1alpha2/clientset/versioned"
	internalinterfaces "k8s.io/cloud-provider-vsphere/pkg/cloudprovider/vsphereparavirtual/client/v1alpha2/informers/externalversions/internalinterfaces"
	v1alpha2 "k8s.io/cloud-provider-vsphere/pkg/cloudprovider/vsphereparavirtual/client/v1alpha2/listers/nsxnetworking/v1alpha2"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NsxV1alpha2().IPPools(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NsxV1alpha2().IPPools(namespace).Watch(context.TODO(), options)
			},
		},
		&nsxnetworkingv1alpha2.IPPool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *iPPoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nsxnetworkingv1alpha2.IPPool{}, f.defaultInformer)
}

func (f *iPPoolInformer) Lister() v1alpha2.IPPoolLister {
	return v1alpha2.NewIPPoolLister(f.Informer().GetIndexer())
}
